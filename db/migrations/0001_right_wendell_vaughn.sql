ALTER TABLE "game_result" DROP CONSTRAINT "game_result_date_format_check";--> statement-breakpoint
...
ALTER TABLE "user_stats" ADD CONSTRAINT "user_stats_last_played_date_format_check" CHECK ("user_stats"."last_played_date" ~ '^[0-9]{4}-[0-9]{2}-[0-9]{2}$');